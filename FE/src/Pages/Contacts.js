...
function Contacts() {
    return (
        <div className="page page-contactts">
            ...
            <div className="contact-item">
                <h3>Social media: </h3>
                <div className="media">
                    <a className="icon-contacts" href="https://uk-ua.facebook.com/"  >
                    ...
                    <a className="icon-contacts" href="https://twitter.com/?lang=ru" >
                    ...
                    <a className="icon-contacts" href="https://www.instagram.com/" >
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" width="50px" height="50px">
            ...
            <div className="contact-item">
                <h3>Email:</h3>
                <p> 
                    <span className="contact_text">E:</span> 
                    <a href="mailto:mail@gmail.com" className="contact_link">ecc-mail@gmail.com</a>
                </p>
            </div>
            <div className="contact-item">
                <h3>Phone number:</h3>
                <p> 
                    <span className="contact_text">C:</span> 
                    <a href="tel:+380999448942" className="contact_link">+380 999 448 942</a>
                </p>
            </div>
        </div>
    )
