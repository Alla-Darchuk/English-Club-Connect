    ...
    return (
        <Navbar  bg="dark" data-bs-theme="dark" className="footer">
            <Nav variant="underline">
                <Nav.Link onClick={() => navigate("contacts")} eventKey="contacts" >Contacts</Nav.Link>
                <Nav.Link onClick={() => navigate("questions")} eventKey="questions">Questions</Nav.Link>
            </Nav>
            <Nav>
                <a className="icon-footer" href="https://uk-ua.facebook.com/">
                ...
                <a className="icon-footer" href="https://twitter.com/?lang=ru">
                ...
                <a className="icon-footer" href="https://www.instagram.com/">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" width="50px" height="50px">
